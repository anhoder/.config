...
function cc-mm
    ANTHROPIC_BASE_URL="$MINIMAX_CC_BASE_URL" ANTHROPIC_AUTH_TOKEN="$MINIMAX_CC_AUTH_TOKEN" ANTHROPIC_MODEL="$MINIMAX_CC_MODEL" ANTHROPIC_SMALL_FAST_MODEL="$MINIMAX_CC_SMALL_FAST_MODEL" ANTHROPIC_DEFAULT_SONNET_MODEL="$MINIMAX_CC_DEFAULT_SONNET_MODEL" ANTHROPIC_DEFAULT_OPUS_MODEL="$MINIMAX_CC_DEFAULT_OPUS_MODEL" ANTHROPIC_DEFAULT_HAIKU_MODEL="$MINIMAX_CC_DEFAULT_HAIKU_MODEL" CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC="$CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC" API_TIMEOUT_MS="$API_TIMEOUT_MS" DISABLE_TELEMETRY="$DISABLE_TELEMETRY" DISABLE_COST_WARNINGS="$DISABLE_COST_WARNINGS" claude $argv
end
